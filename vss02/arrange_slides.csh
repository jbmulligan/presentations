...
set top=vss02_contents
set title='Eye movement dynamics reveal the time course of visual motion processing'
set slide_dir=emc_slides
...
while( $i <= $n )
  ...
  sed -f sub.sed < ../$slide_dir/html/$this_file.html > $this_file.html
...
set i=1
sed -f sub.sed < ../$slide_dir/html/contents_skeleton1.html > $top.html
...
cat ../$slide_dir/html/contents_skeleton2.html >> $top.html
while( $i <= $n )
  set this_file=`head -$i slide_order | tail -1`
  echo '<p><b><font size=+3><a href="' $this_file.html '">' $this_file '</a></font></b>' >> $top.html
  @ i ++
end
cat ../$slide_dir/html/contents_skeleton3.html >> $top.html
