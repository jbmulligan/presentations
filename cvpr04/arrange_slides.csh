...
#set slide_dir=cvpr04_slides
set slide_dir=ranging_slides/html
...
set i=1
sed -f sub.sed < ../$slide_dir/contents_skeleton1.htm > $top.htm
...
cat ../$slide_dir/contents_skeleton2.htm >> $top.htm
while( $i <= $n )
  set this_file=`head -$i slide_order | tail -1`
  echo '<p><b><font size=+3><a href="' $this_file.htm '">' $this_file '</a></font></b>' >> $top.htm
  @ i ++
end
cat ../$slide_dir/contents_skeleton3.htm >> $top.htm
