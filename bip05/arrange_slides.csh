...
set top=sni_contents
set title='Quantifying Performance in Precision VFR Flight'
...
while( $i <= $n )
  ...
  sed -f sub.sed < ../sni_slides/html/$this_file.htm > $this_file.htm
